...
<%@include file="/WEB-INF/jsp/common/tags.jsp"%>
  <form id="qform" name="clippingListForm" method="POST">
  	<table>
  		<tr>
			...
			<td>
				<input type="button" onClick="go('<c:url value="clip.htm?act=doList"/>', 1, '')" value="<spring:message code="text.query"/>">
				<input type="button" onClick="add('<c:url value="clip.htm?act=insert"/>')" value="<spring:message code="text.add"/>">
			</td>
		</tr>
  	</table>
  </form>
