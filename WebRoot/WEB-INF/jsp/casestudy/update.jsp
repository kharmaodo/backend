...
<!-- JSTL START -->
<c:set var="tw_check_1" value="checked"/>
<c:set var="tw_check_2" value=""/>
<c:if test="${command.visibleTW eq 'Y'}">
	<c:set var="tw_check_1" value=""/>
	<c:set var="tw_check_2" value="checked"/>
</c:if> 

<c:set var="en_check_1" value="checked"/>
<c:set var="en_check_2" value=""/>
<c:if test="${command.visibleEN eq 'Y'}">
	<c:set var="en_check_1" value=""/>
	<c:set var="en_check_2" value="checked"/>
</c:if> 

<c:set var="cn_check_1" value="checked"/>
<c:set var="cn_check_2" value=""/>
<c:if test="${command.visibleCN eq 'Y'}">
	<c:set var="cn_check_1" value=""/>
	<c:set var="cn_check_2" value="checked"/>
</c:if> 

<c:set var="jp_check_1" value="checked"/>
<c:set var="jp_check_2" value=""/>
<c:if test="${command.visibleJP eq 'Y'}">
	<c:set var="jp_check_1" value=""/>
	<c:set var="jp_check_2" value="checked"/>
</c:if> 
<!-- JSTL END -->
...
<center>
  <form name="caseStudyEditForm" method="POST" enctype="multipart/form-data" action="<c:url value="case.htm?act=doUpdate"/>">
  <div class="login_L">
  	<table>
  		<tr>
  			...
  			<td class="field">
  				<select name="caseStudyCategoryId">
  					<c:forEach items="${caseStudyCategoryVOs}" var="cscvo">
  						<c:choose>
  							<c:when test="${cscvo.id eq command.caseStudyCategoryId}">
  	...
  	<table>
  		...
  		<tr>
  			...
  			<td class="field">
				<input type="radio" name="visibleTW" value="N" ${tw_check_1}/><spring:message code="text.no"/>&nbsp;&nbsp;
				<input type="radio" name="visibleTW" value="Y" ${tw_check_2}/><spring:message code="text.yes"/>
  			</td>
  			<td>${status.errorMessage}</td>
  			</spring:bind>
  		</tr>
  		...
  		<tr>
  			...
  			<td class="field">
  				<textarea name="contentTW" id="contentTW" cols="42" style="height: 100px;">${status.value}</textarea>
  			</td>
  			<td>${status.errorMessage}</td>
  			</spring:bind>
  		</tr>		
  	...
  	<table>
  		...
  		<tr>
  			...
  			<td class="label"><spring:message code="text.en.visible"/></td>
  			<td class="field">
				<input type="radio" name="visibleEN" value="N" ${en_check_1}/><spring:message code="text.no"/>&nbsp;&nbsp;
				<input type="radio" name="visibleEN" value="Y" ${en_check_2}/><spring:message code="text.yes"/>
  			</td>
  			<td>${status.errorMessage}</td>
  			</spring:bind>
  		</tr>
  		...
  		<tr>
  			...
  			<td class="label"><spring:message code="text.content"/></td>
  			<td class="field">
  				<textarea name="contentEN" id="contentEN" cols="42" style="height: 100px;">${status.value}</textarea>
  			</td>
  			<td>${status.errorMessage}</td>
  			</spring:bind>
  		</tr>		
  	...
  	<table>
  		...
  		<tr>
  			...
  			<td class="label"><spring:message code="text.en.visible"/></td>
  			<td class="field">
				<input type="radio" name="visibleCN" value="N" ${cn_check_1}/><spring:message code="text.no"/>&nbsp;&nbsp;
				<input type="radio" name="visibleCN" value="Y" ${cn_check_2}/><spring:message code="text.yes"/>
  			</td>
  			<td>${status.errorMessage}</td>
  			</spring:bind>
  		</tr>
  		...
  		<tr>
  			...
  			<td class="label"><spring:message code="text.content"/></td>
  			<td class="field">
  				<textarea name="contentCN" id="contentCN" cols="42" style="height: 100px;">${status.value}</textarea>
  			</td>
  			<td>${status.errorMessage}</td>
  			</spring:bind>
  		</tr>		
  	...
  	<table>
  		...
  		<tr>
  			...
  			<td class="label"><spring:message code="text.en.visible"/></td>
  			<td class="field">
				<input type="radio" name="visibleJP" value="N" ${jp_check_1}/><spring:message code="text.no"/>&nbsp;&nbsp;
				<input type="radio" name="visibleJP" value="Y" ${jp_check_2}/><spring:message code="text.yes"/>
  			</td>
  			<td>${status.errorMessage}</td>
  			</spring:bind>
  		</tr>
  		...
  		<tr>
  			...
  			<td class="label"><spring:message code="text.content"/></td>
  			<td class="field">
  				<textarea name="contentJP" id="contentJP" cols="42" style="height: 100px;">${status.value}</textarea>
  			</td>
  			<td>${status.errorMessage}</td>
  			</spring:bind>
  		</tr>		
