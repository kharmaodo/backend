...
<center>
  <form name="industryNewsEditForm" method="POST" action="<c:url value="industryNewsApp.htm?act=doUpdateApp"/>">
  <div class="login_L">
  	<table style="width:800px">
  		...
  		<tr>
  			<td class="field" colspan="3">
  				<spring:message code="text.ciapply.apply.contact"/> : <spring:bind path="command.contact">${status.value}</spring:bind>
  			&nbsp;&nbsp; | &nbsp;&nbsp;
  				<spring:message code="text.ciapply.apply.contact.email"/> : <spring:bind path="command.contactEmail"><a href="mailto:${status.value}">${status.value}</a></spring:bind>
  			&nbsp;&nbsp; | &nbsp;&nbsp;
  				<spring:message code="text.ciapply.apply.contact.phone"/> : <spring:bind path="command.contactTel">${status.value}</spring:bind>
  			</td>
  		</tr>  	
  		</table>
  	</div>
  	...
  	<!-- 正體中文 -->
  		...
  		<table>
	  		<tr>
	  			<td class="label"><spring:message code="industry.news.is.pass"/></td>
	  			<td class="field">
	  				<input type="radio" name="isPass" value="Y" checked/><spring:message code="text.yes"/>&nbsp;&nbsp;
