...
<div id="condition">
  <form id="qform" name="ciApplicationForm" method="POST">
  	<table width="800">
  		<tr>
  			<td>
  			...
  			<td>
  				...
  				<input type="button" onClick="go('<c:url value="imgapp.htm?act=doListImg"/>', 1, '')" value="<spring:message code="text.query"/>">
  			</td>
  		</tr>
  	</table>
  </form>
