...
function clearDate() {
  ...
  <form id="qform" name="announcementListForm" method="POST">
  	<table>
  		<tr>
			...
			<td>
				<input type="button" onClick="go('<c:url value="ann.htm?act=doList"/>', 1, '')" value="<spring:message code="text.query"/>">
				<input type="button" onClick="add('<c:url value="ann.htm?act=insert"/>')" value="<spring:message code="text.add"/>">
			</td>
		</tr>
  	</table>
  </form>
