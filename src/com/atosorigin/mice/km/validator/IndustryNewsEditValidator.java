...
public class IndustryNewsEditValidator implements Validator {

	@Override
	public boolean supports(Class clazz) {
		return clazz.equals(IndustryNewsEditForm.class);
	}
	...
	public void validate(Object command, Errors errors) {
		...
		IndustryNewsEditForm form = (IndustryNewsEditForm)command;
